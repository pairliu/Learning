...
public class ExampleTest {
    ...
    public void removeNonExistingDocument() {
        replay(mock);
        //This method call will not result in any method call on the mock object,
        //because this document doesn't exist. So there is no method call recorded.
    ...
    public void voteForRemoval() {
        ...
        expect(mock.voteForRemoval("Document")).andReturn((byte) 42); //O, this andReturn() means set the return value for that method
        // expect document removal
        mock.documentRemoved("Document");

        replay(mock);
        classUnderTest.addDocument("Document", new byte[0]);
        //In record phase, if you want to assert the return value, use expect()
        //In replay phase, if you want to assert the return value, use the assertTrue()
        //that everyone is familiar with.
        //In record phase, it acts on mock object.
        //In replay phase, it acts on object under test.
